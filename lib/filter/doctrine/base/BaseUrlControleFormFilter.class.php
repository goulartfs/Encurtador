...
abstract class BaseUrlControleFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'resgate_referal_id'      => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ResgateReferal'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'resgate_referal_id'      => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('ResgateReferal'), 'column' => 'id')),
