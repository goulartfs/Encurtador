...
/**
 * ReferalControle filter form base class.
 *
 * @package    Encurtador
 * @subpackage filter
 ...
 */
abstract class BaseReferalControleFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('referal_controle_filters[%s]');
