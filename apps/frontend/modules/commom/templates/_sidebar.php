...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        ...
        <p>
            Se você tem um site com 1 ou 10.000 mil links e deseja mudar para o Adpllus, você tem um script simples, para realizar esta tarefa. <a href="<?php print url_for('@link_script') ?>" title="Page Script Adpllus">Clique aqui</a> para saber mais!
        </p>
