<div class="row">
    <div class="span12">
        <h1 class="head_page">Resgatar via Paypal</h1>
        <form class="form-horizontal" action="<?php print url_for('@retirada_paypal')  ?>" method="post">
            <fieldset>
                <legend>Atualize seus dados do paypal</legend>
