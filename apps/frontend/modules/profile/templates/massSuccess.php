<form class="form-horizontal" action="<?php print url_for('profile/mass') ?>" method="post">
    <fieldset>
        ...
        <div class="control-group">
            <div class="controls">
                <div class="btn-group">
                    <a href="<?php print url_for('profile/links') ?>"><button class="btn" type="button"><i class="icon-arrow-left"></i>&nbsp;Voltar para lista</button></a>
